...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: Category, arg2: string, arg3: number, arg4: Array<string>, arg5: bigint, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4, arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getStoreContent(): Promise<StaticStoreContent> {
        if (this.processError) {
            try {
                const result = await this.actor.getStoreContent();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: bigint, arg1: string, arg2: Category, arg3: string, arg4: number, arg5: Array<string>, arg6: bigint, arg7: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, to_candid_Category_n1(this._uploadFile, this._downloadFile, arg2), arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStoreContent(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStoreContent(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "maleTshirts" in value ? Category.maleTshirts : "femaleDresses" in value ? Category.femaleDresses : "maleShirts" in value ? Category.maleShirts : "kidsApparel" in value ? Category.kidsApparel : value;
}
...
function to_candid_variant_n2(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category): {
    ...
    return value == Category.maleTshirts ? {
        maleTshirts: null
    } : value == Category.femaleDresses ? {
        femaleDresses: null
    } : value == Category.maleShirts ? {
        maleShirts: null
    } : value == Category.kidsApparel ? {
        kidsApparel: null
    } : value;
}
