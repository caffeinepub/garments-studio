...
export class Backend implements backendInterface {
    ...
    async addToCart(arg0: string, arg1: bigint, arg2: string, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async placeOrder(arg0: string, arg1: Array<CartItem>, arg2: number): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async removeFromCart(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
